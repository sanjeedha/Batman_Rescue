...
/**
 * Write a description of class Harley here.
 * 
 * @author  
 * @version 
 */
public class Harley extends Character
{
    ...
    /**
     * Act - do whatever the Harley wants to do. This method is called whenever
    ...
    public void generateEnemies()
    {
        switch(Greenfoot.getRandomNumber(3))
        {
            ...
            case 1:
                getWorld().addObject(new Enemy1(), 2000, getY());
            break;
            
            case 2:
                getWorld().addObject(new Enemy3(), 2000, getY());
            break;
        }
    }
    ...
    /**
     * Check if the Harley is on the screen, if so subtract 's' health.
     * 
     */
